...
public class HubSettings {
    ...
    public static HubSettings fromHubConfig(HubConfig config) {
        ...
        settings.stagingModulesDbName = config.getDbName(DatabaseKind.STAGING);
        settings.stagingTriggersDbName = config.getDbName(DatabaseKind.STAGING);
        settings.stagingSchemasDbName = config.getDbName(DatabaseKind.STAGING);
        ...
        settings.finalModulesDbName = config.getDbName(DatabaseKind.FINAL);
        settings.finalTriggersDbName = config.getDbName(DatabaseKind.FINAL);
        settings.finalSchemasDbName = config.getDbName(DatabaseKind.FINAL);
